...
gta =GTAnalysis('config_1.yaml', logging ={'verbosity' : 3})
gta.setup()
gta.optimize()
...
gta.free_source('4C + 01.02')
gta.fit()
gta.write_roi('fit_model')
gta.sed('4C + 01.02', make_plots=True)
lc = gta.lightcurve('4C + 01.02', free_radius=3.0, nbins=8, multithread=True, nthread=8, use_scaled_srcmap=True)
